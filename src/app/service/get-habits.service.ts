...
export class GetHabitsService {
  ...
  // baseURL:string='http://localhost:4000/habits';
  baseURL:string='/habits';
  ...
  addHabit(habitName:string):Observable<Habit>{
    const newHabit:Habit = {habitName: habitName,mondayCompleted:false,tuesdayCompleted:false,wednesdayCompleted:false,
      thursdayCompleted:false,fridayCompleted:false,saturdayCompleted:false,sundayCompleted:false};
